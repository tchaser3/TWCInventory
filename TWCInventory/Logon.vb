...
'Description:   This form is used to log on the program
...
Public Class Logon
    ...
    Friend mstrStringForSearch As String
    Friend mblnUpdateMSRNumber As Boolean
    Friend mblnUpdateProjectID As Boolean
    Friend mblnProjectIsWHS As Boolean
    Friend mintPickListID As Integer
    Friend mblnNewPartNumber As Boolean
    ...
    Friend mintPartsWarehouseID As Integer
    Friend mstrSelectionOrigination As String
    ...
    Private Sub btnLogon_Click(sender As System.Object, e As System.EventArgs) Handles btnLogon.Click
        ...
        Try
            ...
            MessageBox.Show(mstrFirstName + " " + mstrLastName + " is logged in to TW Inventory", "Thank You", MessageBoxButtons.OK, MessageBoxIcon.Information)
            ...
            mstrSelectionOrigination = "LOGON"
