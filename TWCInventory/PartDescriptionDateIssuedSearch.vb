'Title:         Part Description Date Issued Search
'Date:          7-23-15
'Author:        Terry Holmes

'Description:   This form is used to search for a description and date reange

Option Strict On

Public Class PartDescriptionDateIssuedSearch
    ...
    Private Sub PartDescriptionDateIssuedSearch_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnFindTransactions_Click(sender As Object, e As EventArgs) Handles btnFindTransactions.Click
        ...
        Dim blnKeyWordDoesNotMatch As Boolean
        Dim strPartNumberFromTable As String
        ...
        blnFatalError = TheInputDataValidation.VerifyTextData(strPartDescriptionForSearch)
        If blnFatalError = True Then
            blnThereIsAProblem = True
        ...
        mstrPartDescription = strPartDescriptionFromTable
        ...
        For intCounter = 0 To mintIssuedUpperLimit
            ...
            strPartDescriptionFromTable = FindPartDescription(strPartNumberFromTable)
            blnKeyWordDoesNotMatch = TheKeyWordSearchClass.FindKeyWord(strPartDescriptionForSearch, strPartDescriptionFromTable)

            If datDateFromTable >= mdatStartDate Then
                If datDateFromTable <= mdatEndDate Then
                    If blnKeyWordDoesNotMatch = False Then
                        ...
                        row = New String() {CStr(structSearchResults(mintResultsCounter).mdatDate), structSearchResults(mintResultsCounter).mstrProjectID, structSearchResults(mintResultsCounter).mstrPartNumber, strPartDescriptionFromTable, CStr(structSearchResults(mintResultsCounter).mintQuantity)}
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        PrintX = 200
        e.Graphics.DrawString("Project Part Number " + mstrPartDescription + " Issued Between " + CStr(mdatStartDate) + " And " + CStr(mdatEndDate), PrintSubHeaderFont, Brushes.Black, PrintX, PrintY)
        PrintY = PrintY + HeadingLineHeight
