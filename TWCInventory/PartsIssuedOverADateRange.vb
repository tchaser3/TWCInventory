'Title:         Parts Issued Over a Date Range
'Date:          7-22-15
'Author:        Terry Holmes

'Description:   This form will show all parts that were issued over a date range

Option Strict On

Public Class PartsIssuedOverADateRange
    ...
    Private Sub PartsIssuedOverADateRange_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        PrintX = 270
        e.Graphics.DrawString("Project Part Issued Between " + CStr(mdatStartDate) + " And " + CStr(mdatEndDate), PrintSubHeaderFont, Brushes.Black, PrintX, PrintY)
        PrintY = PrintY + HeadingLineHeight
