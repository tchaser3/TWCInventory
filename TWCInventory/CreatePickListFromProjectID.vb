'Title:         Create Pick List From Project ID
'Date:          4-1-15
'Author:        Terry Holmes

'Description:   This program creates a pick list from a project id

Option Strict On

Public Class CreatePickListFromProjectID
    ...
    Private Sub CreatePickListFromProjectID_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        'This will load when the form is loaded
        Logon.mstrLastTransactionSummary = "LOADED CREATE PICK LIST FROM PROJECT ID"
    ...
    Private Sub btnFindMSRNumber_Click(sender As Object, e As EventArgs) Handles btnFindMSRNumber.Click
        ...
        If blnItemNotFound = True Then
            PartsReceivedGridView.Visible = False
            SetControlsVisible(False)
            MessageBox.Show("Project ID Not Found", "Try Again", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
    ...
    Private Sub btnProcess_Click(sender As Object, e As EventArgs) Handles btnProcess.Click
        ...
        Logon.mintPickListID = CInt(strPickListIDFromTable)
        PrintPickList.Show()
        Logon.mstrLastTransactionSummary = "CREATED PICK LIST FOR PROJECT " + strPickListIDFromTable
